...
export default function Designers() {
  ...
  const selectDesignerLine = (lineId, lineTitle, lineSummary) => {
        ...
        <Grid>
          ...
          <Grid item xs={12}>
            <Box className={classes.grid}>
              <Button onClick={goBackToAllDesigners} className={classes.button} variant="contained" startIcon={<ArrowBackIcon />}>Back to All Designers</Button>
            </Box>
          </Grid>
        </Grid>
      </Paper>
